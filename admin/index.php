            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="index.php?page=tampil_mhs"><i class="fa fa-desktop"></i> Data Mahasiswa <span class="fa fa-chevron"></span></a>
                  </li>
                  <li><a href="index.php?page=tampil_dosen"><i class="fa fa-desktop"></i> Data Dosen <span class="fa fa-chevron"></span></a>
                  </li>
