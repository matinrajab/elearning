                    ...
                    if(mysqli_num_rows($result) > 0){
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?page=ubah_mhs&nrp='.$row['nrp'].'" class="btn btn-secondary btn-sm">Edit</a>
                                    <a href="index.php?page=hapus_mhs&nrp='.$row['nrp'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data '.$row['nrp'].'?\')">Delete</a>
                                </td>
                            </tr>
                            ';
                            $no++;
