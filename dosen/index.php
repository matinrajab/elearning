            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="index.php?page=upload_tugas"><i class="fa fa-book"></i> Upload Tugas <span class="fa fa-chevron"></span></a>
                  </li>
                  <li><a href="index.php?page=list_tugas"><i class="fa fa-book"></i> Daftar Tugas <span class="fa fa-chevron"></span></a>
                  </li>
